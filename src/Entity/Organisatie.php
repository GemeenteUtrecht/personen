...
class Organisatie implements StringableInterface
{
	...
	/**
	 * Personen die bij deze organisatie horen
	 *
	 * @var \Doctrine\Common\Collections\Collection|\App\Entity\Persoon[]|null
	 *
	 * @ORM\OneToMany(
	...
	/**
	 * Wijziging die bij deze organisatie horen
	 *
	 * @var \Doctrine\Common\Collections\Collection|\App\Entity\Wijziging[]|null
	 *
	 * @ORM\OneToMany(
	 * 		targetEntity="\App\Entity\Wijziging",
	 * 		mappedBy="bronOrganisatie")
	 *
	 */
	public $wijzigingen;
